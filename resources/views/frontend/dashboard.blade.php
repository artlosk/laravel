            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-sm border-0 transition-all" style="transition: transform 0.3s;">
                    <div class="card-body text-center">
                        ...
                        <a href="{{ route('frontend.password') }}" class="btn btn-outline-danger mt-3">Change Password</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-sm border-0 transition-all" style="transition: transform 0.3s;">
                    <div class="card-body text-center">
                        ...
                        <a href="{{ route('frontend.posts.index') }}" class="btn btn-outline-success mt-3">View Posts</a>
                    </div>
                </div>
            </div>
        </div>
